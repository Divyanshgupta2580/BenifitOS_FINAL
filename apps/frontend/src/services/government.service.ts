...
export type ServiceStatus = 'CONNECTED' | 'NOT_CONNECTED' | 'VERIFIED' | 'PENDING' | 'EXPIRED';
...
export const INITIAL_GOVERNMENT_SERVICES: GovernmentServiceItem[] = [
  {
    ...
    category: 'IDENTITY',
    status: 'VERIFIED',
    lastSynced: '2026-08-07 14:00',
    health: 'HEALTHY',
    description: 'Unique Identification Authority of India e-KYC integration',
    icon: '🆔',
  },
  {
    id: 'gov-2',
    ...
    category: 'DOCUMENTS',
    status: 'CONNECTED',
    lastSynced: '2026-08-07 12:30',
    health: 'HEALTHY',
    description: 'Ministry of Electronics & IT Digital Document Repository',
    icon: '📂',
  },
  {
    id: 'gov-3',
    ...
    category: 'HEALTH',
    status: 'CONNECTED',
    lastSynced: '2026-08-06 18:45',
    health: 'HEALTHY',
    description: 'National Health Authority Digital Health Identity ID',
    icon: '🏥',
  },
  {
    id: 'gov-4',
    ...
    status: 'VERIFIED',
    lastSynced: '2026-08-05 09:15',
    health: 'HEALTHY',
    description: 'Direct Benefit Transfer Agricultural Landholder Account',
    icon: '🌾',
  },
  {
    id: 'gov-5',
