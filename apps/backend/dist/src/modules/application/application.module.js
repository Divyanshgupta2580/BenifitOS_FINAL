...
exports.ApplicationModule = ApplicationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            { provide: 'IApplicationRepository', useClass: application_repository_1.ApplicationRepositoryImpl },
        ],
        exports: [application_service_1.ApplicationService, 'IApplicationRepository'],
    })
], ApplicationModule);
