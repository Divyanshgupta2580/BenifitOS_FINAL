            ...
            rules: [
                {
                    ...
                    targetValue: 'FARMER',
                    isRequired: true,
                    description: 'Must be engaged in farming / agriculture',
                },
                {
                    ...
                    targetValue: '400000',
                    isRequired: true,
                    description: 'Annual family income must not exceed Rs 4,00,000',
                },
            ],
            documents: [
                { documentType: 'AADHAAR', isMandatory: true, description: 'Aadhaar Card for identity verification' },
                { documentType: 'VOTER_ID', isMandatory: true, description: 'Voter ID for electoral residency verification' },
            ],
        },
        {
            ...
            rules: [
                {
                    ...
                    targetValue: '600000',
                    isRequired: true,
                    description: 'Annual family income must be under Rs 6,00,000',
                },
                {
                    attributeKey: 'age',
            ...
            documents: [
                ...
                { documentType: 'VOTER_ID', isMandatory: true, description: 'Voter ID proof of residence' },
            ],
        },
        {
            ...
            rules: [
                {
                    ...
                    targetValue: 'STUDENT',
                    isRequired: true,
                    description: 'Must be an enrolled student',
                },
                {
                    attributeKey: 'annualIncomeINR',
                    operator: 'LESS_EQUAL',
            ...
            documents: [
                { documentType: 'EDUCATIONAL_CERTIFICATE', isMandatory: true, description: 'Previous academic marksheet/certificate' },
            ...
            rules: [
                {
                    ...
                    targetValue: 'STUDENT',
                    isRequired: true,
                    description: 'Must be a student enrolled in a recognized institution',
                },
                {
                    attributeKey: 'annualIncomeINR',
                    operator: 'LESS_EQUAL',
            ...
            rules: [
                {
                    ...
                    targetValue: '800000',
                    isRequired: true,
                    description: 'Annual income must be under Rs 8,00,000',
                },
                {
                    attributeKey: 'age',
                    operator: 'GREATER_EQUAL',
                    targetValue: '18',
                    isRequired: true,
                    description: 'Applicant must be an adult citizen',
                },
            ],
            documents: [
                { documentType: 'AADHAAR', isMandatory: true, description: 'Aadhaar Card for e-KYC' },
                { documentType: 'CASTE_CERTIFICATE', isMandatory: false, description: 'Caste Certificate if claiming reservation category' },
            ],
        },
        {
            ...
            documents: [
                ...
                { documentType: 'DRIVING_LICENSE', isMandatory: false, description: 'Driving Licence for commercial transport ventures' },
            ],
        },
        {
            ...
            rules: [
                ...
                },
                {
                    ...
                    targetValue: '250000',
                    isRequired: true,
                    description: 'Annual income must not exceed Rs 2,50,000',
                },
            ],
            documents: [
                { documentType: 'BIRTH_CERTIFICATE', isMandatory: true, description: 'Birth Certificate or Age Proof document' },
